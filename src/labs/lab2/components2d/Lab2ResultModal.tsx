      ...
      >
        ...
        <div className="flex items-center gap-4 px-6 py-5" style={{ background: `linear-gradient(135deg, ${t.color}22, #ffffff)` }}>
          ...
          <div>
            ...
            <p className="text-[13px] text-slate-500">Gram bo'yash — imtihon natijasi (PDF mezoni)</p>
          </div>
        </div>
              ...
              <p className="font-semibold" style={{ color: result.classification.isRight ? "#059669" : "#dc2626" }}>
                {result.classification.picked == null
                  ...
                  : result.classification.isRight
                    ? "Gram tegishliligi to'g'ri aniqlandi"
                    : "Gram tegishliligi noto'g'ri aniqlandi"}
              </p>
              <p className="text-slate-500">To'g'ri javob: {result.classification.correct === "positive" ? "Gram-musbat (binafsha)" : "Gram-manfiy (qizil)"}</p>
            </div>
          </div>
