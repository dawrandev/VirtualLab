...
export const MAIN_STEPS: MainStep[] = [
  {
    id: "gentian-violet",
    card: "lab2.steps.gvCard",
    result: "lab2.steps.gvResult",
    full: 10,
    partial: 5,
    requires: [],
  },
  {
    id: "lugol",
    card: "lab2.steps.lugolCard",
    result: "lab2.steps.lugolResult",
    full: 20,
    partial: 10,
  ...
  {
    id: "decolorize",
    card: "lab2.steps.alcoholCard",
    result: "lab2.steps.alcoholResult",
    full: 24,
    partial: 12,
    requires: ["lugol"],
  },
  {
    id: "fuchsin",
    card: "lab2.steps.fuchsinCard",
    result: "lab2.steps.fuchsinResult",
    full: 28,
    partial: 14,
    requires: ["decolorize"],
  },
  {
    id: "classify",
    card: "lab2.steps.classifyCard",
    result: "lab2.steps.classifyResult",
    full: 18,
    partial: 9,
    requires: ["fuchsin"],
  },
